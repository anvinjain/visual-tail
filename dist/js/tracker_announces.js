...
},{"../lib/datasource/http-streaming-json-source":2,"../lib/vis/announces":4,"../lib/vis/announces/payload":5}],2:[function(require,module,exports){
 ...
 * 
 * Registered callback receives events of different types:
 *  {type: "error", msg: "error message", err: <error object>}
 *  {type: "stat_chunk", msg: {elapsed: <time interval between current and prev chunk in millis>}}
 *  {type: "data", msg: <transformed object>}
 */
...
},{"./examples/tracker-announces":1,"./lib/util":3,"jquery":7}]},{},[9])

//# sourceMappingURL=tracker_announces.js.map
